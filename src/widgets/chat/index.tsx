    ...
    <div className={styles.wrapper} data-testid="chat-widget">
      {messages?.length || oldMessages?.data?.length || activeMessage.text ? (
        ...
        <div className={styles.empty}>
          ...
          <p>
            Если вам недостаточно чатов, вы можете добавить их, выбрав нужный шаблон из списка. Если вы не нашли нужный
            шаблон, обратитесь в поддержку для его добавления.
          </p>
          <AddChatList />
        </div>
      )}
